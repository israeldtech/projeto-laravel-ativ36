...
<head>
    ...
    <link rel="shortcut icon" href="/img/construindo.png" type="image/x-icon">
...
<body>
    <header class="container">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="/"><img src="/img/construindo.png" alt="logo" width="30px"></a>
    ...
    <footer class="container">
        <p>&copy; Estudos Laravel | Israel</p>
    </footer>
